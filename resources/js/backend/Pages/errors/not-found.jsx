...
import ErrorLogo from './../../assets/images/error/404-light.svg'
import {Link} from "react-router-dom";
import {AdminURL} from "@/backend/hook/useAdminUrl.js";
const NotFound = () => {
    return (
        <div>
            <div className="relative flex min-h-screen items-center justify-center overflow-hidden">
                ...
                >
                    <div className="relative">
                        ...
                        <Link to={`${AdminURL}/dashboard`}
                           className="btn btn-gradient mx-auto !mt-7 w-max border-0 uppercase shadow-none">Home</Link>
                    </div>
                </div>
            </div>
        </div>
