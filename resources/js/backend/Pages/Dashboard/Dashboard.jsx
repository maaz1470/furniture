        ...
        <div>
                ...
                <div x-data="finance">
                    <ul className="flex space-x-2 rtl:space-x-reverse">
                        ...
                        <li className="before:content-['/'] before:mr-1 rtl:before:ml-1">
                            <span>Finance</span>
                        </li>
                    </ul>
                    <div className="pt-5">
                        ...
                        <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
                            <div>
                                <div className="mb-5 flex items-center font-bold">
                                    ...
                                    <a
                                        href="#"
                                        className="text-primary hover:text-black ml-auto rtl:mr-auto dark:hover:text-white-dark"
                                    >
                                        See All
                                    </a>
                                </div>
                            ...
                            <div>
                                ...
                                <div className="mb-6 grid grid-cols-1 gap-6 sm:grid-cols-3">
                                    <div className="panel">
                                        ...
                                        <div className="mb-5 overflow-hidden5">
                            ...
                            <div className="grid gap-6 xl:grid-flow-row">
                                <div className="panel overflow-hidden">
                                    ...
                                    <div className="relative mt-10">
                                        <div className="absolute -bottom-12 h-24 w-24 -right-12 rtl:-left-12">
                                            <svg
                                                width="24"
                                                height="24"
                                                viewBox="0 0 24 24"
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th>NAME</th>
                                                <th>AMOUNT</th>
                                                <th className="text-center rounded-r-md rtl:rounded-l-md">
                                                    STATUS
                                                </th>
                                            </tr>
                                        </thead>
