...
const DashboardLayout = () => {
    ...
    useEffect(() => {
        ...
        } else if (location.pathname == `${AdminURL}/tag`) {
            setExpandMenu({
                tag: true
            })
        }
    ...
    return (
        <div>
            ...
            ></div>
            <div
                className="fixed bottom-6 z-50 right-6 rtl:left-6"
                x-data="true"
            >
                {showTopButton && (
                    <div>
                            ...
                            <ul className="perfect-scrollbar   relative h-[calc(100vh-80px)] space-y-0.5  overflow-y-scroll scrollbar-w-2 scrollbar-track-gray-200 scrollbar-thumb-gray-500 scrollbar-thumb-rounded-lg    p-4 py-0 font-semibold ps ps--active-y ">
                                <li className="menu nav-item">
                                    <Link
                                        ...
                                        type="button"
                                        className={`nav-link group ${expandMenu.dashboard && "active"
                                            }`}
                                        onClick={(e) =>
                                            handleExpandMenu(
                                                e,
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`rtl:rotate-180 ${expandMenu.dashboard &&
                                                "!rotate-90"
                                                }`}
                                        ></div>
                                    </Link>
                                ...
                                <li className="nav-item">
                                    <ul>
                                        <li className="nav-item">
                                            <button
                                                className={`group ${expandMenu.category &&
                                                    "active"
                                                    }`}
                                                onClick={(e) =>
                                                    handleExpandMenu(
                                            ...
                                            >
                                                ...
                                                <div
                                                    className={`rtl:rotate-180 transition-all ${expandMenu.category &&
                                                        "!rotate-90"
                                                        }`}
                                                >
                                                    <svg
                                        ...
                                        <li className="nav-item">
                                            <Link
                                                to={`${AdminURL}/tag`}
                                                className={`group ${expandMenu.tag && 'active'}`}
                                                onClick={(e) => handleExpandMenu(e, !expandMenu.tag)}
                                                name="tag"
                                            >
                                                <div className="flex items-center">
                                                    <svg
                                        ...
                                        <li className="menu nav-item">
                                            <Link
                                                to={`${AdminURL}/dashboard`}
                                                className={`nav-link group ${expandMenu.invoice &&
                                                    "active"
                                                    }`}
                                                onClick={(e) =>
                                                    handleExpandMenu(
                                            ...
                                            >
                                                ...
                                                <div
                                                    className={`rtl:rotate-180 transition-all ${expandMenu.invoice &&
                                                        "!rotate-90"
                                                        }`}
                                                >
                                                    <svg
                                ...
                                <li className="menu nav-item">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a href="components-counter.html">
                                                Counter
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="components-pricing-table.html">
                                                Pricing Tables
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <li className="menu nav-item">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a href="elements-buttons-group.html">
                                                Button Groups
                                            </a>
                                        </li>
                                        <li>
                                            <a href="elements-color-library.html">
                                                Color Library
                                            </a>
                                        </li>
                                        <li>
                                            <a href="elements-dropdown.html">
                                                Dropdown
                                            </a>
                                        </li>
                                        <li>
                                            <a href="elements-infobox.html">
                                                Infobox
                                            </a>
                                        </li>
                                        <li>
                                            <a href="elements-jumbotron.html">
                                                Jumbotron
                                            </a>
                                        </li>
                                        <li>
                                            <a href="elements-loader.html">
                                                Loader
                                            </a>
                                        </li>
                                        <li>
                                            <a href="elements-pagination.html">
                                                Pagination
                                            </a>
                                        </li>
                                        <li>
                                            <a href="elements-popovers.html">
                                                Popovers
                                            </a>
                                        </li>
                                        <li>
                                            <a href="elements-progress-bar.html">
                                                Progress Bar
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <li className="menu nav-item">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a href="datatables-skin.html">
                                                Skin
                                            </a>
                                        </li>
                                        <li>
                                            <a href="datatables-order-sorting.html">
                                                Order Sorting
                                            </a>
                                        </li>
                                        <li>
                                            <a href="datatables-multi-column.html">
                                                Multi Column
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="datatables-alt-pagination.html">
                                                Alt. Pagination
                                            </a>
                                        </li>
                                        <li>
                                            <a href="datatables-checkbox.html">
                                                Checkbox
                                            </a>
                                        </li>
                                        <li>
                                            <a href="datatables-range-search.html">
                                                Range Search
                                            </a>
                                        </li>
                                        <li>
                                            <a href="datatables-export.html">
                                                Export
                                            </a>
                                        </li>
                                        <li>
                                            <a href="datatables-sticky-header.html">
                                                Sticky Header
                                            </a>
                                        </li>
                                        <li>
                                            <a href="datatables-clone-header.html">
                                                Clone Header
                                            </a>
                                        </li>
                                        <li>
                                            <a href="datatables-column-chooser.html">
                                                Column Chooser
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li className="menu nav-item">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a href="forms-quill-editor.html">
                                                Quill Editor
                                            </a>
                                        </li>
                                        <li>
                                            <a href="forms-markdown-editor.html">
                                                Markdown Editor
                                            </a>
                                        </li>
                                        <li>
                                            <a href="forms-date-picker.html">
                                                Date & Range Picker
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <li className="menu nav-item">
                                    ...
                                    >
                                        <li>
                                            <a href="pages-knowledge-base.html">
                                                Knowledge Base
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="pages-contact-us-boxed.html"
                                                target="_blank"
                                            >
                                                Contact Us Boxed
                                            </a>
                                        ...
                                        <li>
                                            <a
                                                href="pages-contact-us-cover.html"
                                                target="_blank"
                                            >
                                                Contact Us Cover
                                            </a>
                                        ...
                                        <li>
                                            <a
                                                href="pages-coming-soon-boxed.html"
                                                target="_blank"
                                            >
                                                Coming Soon Boxed
                                            </a>
                                        ...
                                        <li>
                                            <a
                                                href="pages-coming-soon-cover.html"
                                                target="_blank"
                                            >
                                                Coming Soon Cover
                                            </a>
                                        ...
                                        <li x-data="{subActive:null}">
                                            <button
                                                type="button"
                                                className="before:h-[5px] before:w-[5px] before:rounded before:bg-gray-300 hover:bg-gray-100 before:mr-2 rtl:before:ml-2 dark:text-[#888ea8] dark:hover:bg-gray-900"
                                            >
                                                Error
                                                <div className="ml-auto rtl:mr-auto rtl:rotate-180">
                                                    <svg
                                                        width="16"
                                                        height="16"
                                                        viewBox="0 0 24 24"
                                            ...
                                            <ul
                                                className="sub-menu text-gray-500 ml-2 rtl:mr-2"
                                ...
                                <li className="menu nav-item">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a
                                                href="auth-cover-lockscreen.html"
                                                target="_blank"
                                            >
                                                Unlock Cover
                                            </a>
                        ...
                        <div className="shadow-sm">
                            <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                                ...
                                <div className="flex items-center space-x-1.5 ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                                    <div
                                        className="sm:mr-auto sm:rtl:ml-auto"
                                        x-data="{ search: false }"
                                    >
                                        <button
                                            type="button"
                            ...
                            <ul className="horizontal-menu hidden border-t border-[#ebedf2] bg-white py-1.5 px-6 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-[#0e1726] dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
                                ...
                                <li className="menu nav-item relative">
                                    ...
                                    <ul className="sub-menu">
                                        ...
                                        <li className="relative">
                                            ...
                                            <ul className="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                                <li>
                                                    <a href="apps-invoice-list.html">
                                                        List
                                                    </a>
